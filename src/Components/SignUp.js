...
const SignUp = () => {
  ...
  const createUserWithEmailAndPasswordHandler = async (
    ...
    if (
      ...
      return setError(
        "Error Signing up Password and Confirm password must be same OR password length is less than 8"
      );
    ...
    try {
      ...
      setError("User Already registered or Invalid SignUp Details Provided");
    }
